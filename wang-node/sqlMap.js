var sqlMap = {
    ...
    carinfo:{
        //新建车辆
        add:'insert into carinfo(username,carNo,date,isShow,company,wholePhoto,status,plate_number,is_code) values (?,?,?,1,?,?,"删除",?,?)',
        //显示所有车辆
        ...
        updateCar:'update carinfo set engine=?,VIN=?,traverse=?,speedchanger=?,front=?,back=?,VIN_number=?,engine_number=? where username=? and carNo=?',
